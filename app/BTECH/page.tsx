...
const btech: CourseData = {
    ...
    branches: [
        ...
        },
        {
            ...
            duration: "4 Years",
            description:
                "Provides comprehensive knowledge of infrastructure development, structural design, construction management, transportation systems, and sustainable engineering practices.",
            highlights: [
